...
var resourceLibrary = {
	...
	scenes: [
		...
		{coords: [hexSize,60], duration: 10, time: 40, year: '1950', title: 'Tent Camp', pieces: [
			// Example set piece:
			//     {type: 'image or video', source: 'a uri, or {webm: 'a uri', etc}', coords: [x, y, z], dimentions: [width, height]}
		...
		{coords: [hexSize,120], duration: 50, time: 50, year: '1964', title: 'Artists Village', pieces: [
			//     {type: 'image or video', source: 'a uri, or {webm: 'a uri', etc}', coords: [x, y, z], dimentions: [width, height]}
		...
		{coords: [hexSize,180], duration: 15, time: 100, year: '2011', title: 'Slum', pieces: [
			// Example set piece:
			//     {type: 'image or video', source: 'a uri, or {webm: 'a uri', etc}', coords: [x, y, z], dimentions: [width, height]}
		...
		{coords: [hexSize,240], duration: 15, time: 115, year: '2011', title: 'Slum', pieces: [
			// Example set piece:
			//     {type: 'image or video', source: 'a uri, or {webm: 'a uri', etc}', coords: [x, y, z], dimentions: [width, height]}
		...
		{coords: [hexSize,300], duration: 10, time: 130, year: '2014', title: 'Skyscraper', pieces: [
			// Example set piece:
			//     {type: 'image or video', source: 'a uri, or {webm: 'a uri', etc}', coords: [x, y, z], dimentions: [width, height]}
